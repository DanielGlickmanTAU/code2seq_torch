...
class PFedHnTest(TestCase):
    ...
    def test_batched_train_predict_client_grad(self):
        args = get_args()
        args.hyper_batch_size = 4
        args.num_steps = 15
        args.num_nodes = 10
        args.eval_every = 5
        args.predict_client_grad = True
        ...
        self.assertAlmostEqual(val_best, 0.6398139813981398, delta=0.01)
        self.assertAlmostEqual(test_best, 0.640906362545018, delta=0.01)

    def test_batched_train_client_network_to_embedding(self):
        args = get_args()
        args.hyper_batch_size = 4
        args.num_steps = 15
        args.num_nodes = 10
        args.eval_every = 5
        args.predict_client_grad = False
        args.use_client_network_as_embedding = True
