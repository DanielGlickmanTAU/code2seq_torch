...
def base_dict():
    ...
    l.append('50')
    l.append('gd.edge_model_type')
    l.append('bn-mlp')
    l.append('gd.edge_reduction')
    l.append('linear')
    l.append('gd.ffn_layers')
    l.append('1')
    l.append('gd.learn_edges_weight')
    l.append('True')
    l.append('gt.dropout')
    l.append('0.1')
