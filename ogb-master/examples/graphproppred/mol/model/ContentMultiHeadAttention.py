...
class ContentMultiheadAttention(torch.nn.Module):
    ...
    Outputs:
        ...
        if not self._qkv_same_embed_dim:
            ...
            attn_output, attn_output_weights = hook_multi_head_attention_forward(
...
def hook_multi_head_attention_forward(
        query: Tensor,
        key: Tensor,
        value: Tensor,
        ...
        alter_mask=None) -> Tuple[Tensor, Optional[Tensor]]:
    r"""
    Args:
    ...
    #
    if alter_mask:
        attn_mask = alter_mask(attn_mask)
