...
params_for_grid_search.update({
    'gnn': ['gin'],
    'JK': ['sum'],
    # 'JK': 'sum',
    'scheduler_use_max': True
})

params = {
    'drop_ratio': 0.,
    'patience': 60,
    'exp_name': 'gnn-4-restore-benchmark-fixed-2',
    # 'gnn': 'gin',
    'graph_pooling': 'sum',
...
# graph_benchmark_search_params = get_benchmarking_gnns_hyperparam_search_space_alternative()
